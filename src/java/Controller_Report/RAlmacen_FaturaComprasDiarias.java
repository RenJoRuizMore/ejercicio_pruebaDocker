...
public class RAlmacen_FaturaComprasDiarias extends ActionSupport{
	...
	public String execute() throws Exception {
		try {
				...
				String query="SELECT fact.numero_factura,prov.nombre_proveedor,\n" +
                                            ...
                                            "where estado_factura= 1 and concat(fact.numero_factura,' ',prov.nombre_proveedor ) and fecha_factura = curdate() \n" +
				...
				pdfName = "ReporteFacturaCompras";
				rpt = "ReporteFacturaCompra.jrxml";
