...
public class RVendidos_PorTarjeta extends ActionSupport{
    ...
    private String archivo_jasper="VentaTarjeta.jasper";
        ...
        // el obejto con el pojo 
         try {
             ...
             String query="select p.numero_pedido,codigo_producto,descripcion_producto,pr.precio_producto,\n" +
                    ...
                    "(select sum(monto_total_pedido) from pedido where tipo_pago=2 and fecha_pedido=curdate()) as suma\n" +
                    " from pedido p \n" +
                    ...
                    "where p.fecha_pedido=curdate() and  p.tipo_pago=2\n" +
            ...
            while(resul.next()){
             ...
             try {
                 ...
                 JasperCompileManager.compileReportToFile(
                         getApplicationPath() + "/reportes/VentaTarjeta.jrxml",
                         getApplicationPath() + "/reportes/VentaTarjeta.jasper");
             } catch (JRException e) {
