...
public class RVendedor_Reporte extends ActionSupport{
	...
	public String execute() throws Exception {
		try {
				...
				String query="select numero_pedido,(case tipo_documento when 1 then 'Boleta' when 2 then 'Factura' end) as tipo_documento  ,\n" +
                                              "(case tipo_pago when 1 then 'contado' when 2 then 'Con Tarjeta' end) as tipo_pago ," +
                                                "igv_pedido, monto_total_pedido from  pedido p \n" +
                                                ...
                                                " and us.id_usuario= " + getId_usuario_venta_e() + " group by numero_pedido;";
