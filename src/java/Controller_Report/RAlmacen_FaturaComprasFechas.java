...
public class RAlmacen_FaturaComprasFechas extends ActionSupport {
	...
	public String execute() throws Exception {
		try {
				...
				String query="SELECT fact.numero_factura,prov.nombre_proveedor,\n" +
                                            ...
                                            "where estado_factura= 1 and concat(fact.numero_factura,' ',prov.nombre_proveedor) and fecha_factura between '"+ getFini() +"' and '"+ getFfin() +"'\n" +
				...
				pdfName = "ReporteFacturaComprasFechas";
				rpt = "ReporteFacturaCompraFechas.jrxml";
