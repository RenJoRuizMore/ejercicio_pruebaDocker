<%-- 
    Document   : v_creporteproductos
    Created on : 13/10/2019, 09:47:25 AM
    Author     : Rene Jose
--%>
...
<head>
	...
	<meta charset="utf-8">
        ...
        <!---->
        <script type="text/javascript" src="./funciones_js/cajero/JS_Cprodvendidos.js"> </script>
        <style type="text/css">
            .separador{
...
<body class="inner_page innerpage">
	...
	<%@ include file="../plantillas/cajero/menu.jsp" %> 
        ...
        <div id="container">
            <!--cabecera contenedor -->
            <%@ include file="../plantillas/cajero/header.jsp" %>            
            <!--final de cabecera -->
            <!--  cuerpo-->
            <div class="container">
              <div class="row">
