...
<head>
	...
	<meta charset="utf-8">
        ...
        <script type="text/javascript" src="./funciones_js/cajero/JS_AperturarCaja.js"> </script>
        <style type="text/css">
            .separador{
                    ...
                    <div class="col-md-12 basic">
                        <div class="place_li_cont">
                              ...
                              <div class="post p_style_one">
                                  <div class="post_info">
                                    <div class="row">
                                        <h2><a href="08.html">Abrir Caja</a><span></span></h2>
                                        ...
                                        <div class="row col-md-12 text-center">
                                         ...
                                         <div class="row col-md-12 text-center" id="btns_control_caja">
                                           ...
                                           <button type="button" class="btn btn-lg btn-warning" id="btn_abrircaja">
                                              <i class="fa  fa-cart-plus"></i> ABRIR CAJA </button>
